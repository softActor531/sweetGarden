<?php
$show_related = satine_elated_options()->getOptionValue('blog_single_related_posts') == 'yes' ? true : false;
$related_post_number = satine_elated_sidebar_layout() === 'no-sidebar' ? 4 : 3;
$related_posts_options = array(
    'posts_per_page' => $related_post_number
);
$related_posts = satine_elated_get_blog_related_post_type(get_the_ID(), $related_posts_options);
        ...
        <div class="eltdf-related-posts-holder-inner">
            <?php if ( $related_posts && $related_posts->have_posts() ) : ?>
                <div class="eltdf-related-posts-title">
                    <h2><?php esc_html_e('RELATED POSTS', 'satine' ); ?></h2>
                </div>
