...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Elated Product List - Carousel', 'satine'),
			'base' => $this->base,
			...
			'params' => array(
					...
					array(
						...
						'heading'    => esc_html__('Number Of Visible Items', 'satine'),
						'value'      => array(
						...
						'save_always' => true,
						'group'       => esc_html__('Slider Settings', 'satine')
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'slider_loop',
						'heading'     => esc_html__('Enable Slider Loop', 'satine'),
					...
					array(
						...
						'heading'     => esc_html__('Enable Slider Autoplay', 'satine'),
						'value'       => array_flip(satine_elated_get_yes_no_select_array(false, true)),
						'save_always' => true,
						'group'       => esc_html__('Slider Settings', 'satine')
					),
					array(
						...
						'heading'     => esc_html__('Slider Speed', 'satine'),
						'description' => esc_html__('Default value is 5000 (ms)', 'satine'),
						'group'       => esc_html__('Slider Settings', 'satine')
					),
					array(
						'type'        => 'textfield',
						'param_name'  => 'slider_speed_animation',
						'heading'     => esc_html__('Slider Slide Animation', 'satine'),
						'description' => esc_html__('Speed of slide animation in milliseconds. Default value is 600.', 'satine'),
						'group'       => esc_html__('Slider Settings', 'satine')
					),
					array(
						'type'		  => 'dropdown',
						'param_name'  => 'slider_navigation',
						'heading'	  => esc_html__('Enable Slider Navigation Arrows', 'satine'),
						'value'       => array_flip(satine_elated_get_yes_no_select_array(false, true)),
						'save_always' => true,
						'group'       => esc_html__('Slider Settings', 'satine')
					),
					array(
						...
						'heading'    => esc_html__('Slider Navigation Skin', 'satine'),
						'value'      => array(
					...
					array(
						...
						'heading'	  => esc_html__('Enable Slider Pagination', 'satine'),
						'value'       => array_flip(satine_elated_get_yes_no_select_array(false, true)),
						'save_always' => true,
						'group'       => esc_html__('Slider Settings', 'satine')
					),
					array(
						...
						'heading'    => esc_html__('Slider Pagination Skin', 'satine'),
						'value'      => array(
							esc_html__('Default', 'satine') => 'default',
							esc_html__('Light', 'satine')   => 'light'
						),
					...
					array(
						...
						'heading'    => esc_html__('Slider Pagination Position', 'satine'),
						'value'      => array(
							esc_html__('Below Carousel', 'satine')  => 'bellow-slider',
							esc_html__('Inside Carousel', 'satine') => 'inside-slider'
						),
						'dependency'  => array('element' => 'slider_pagination', 'value' => array('yes')),
						'group'       => esc_html__('Slider Settings', 'satine')
					),
	...
	public function render($atts, $content = null) {
		...
		$html = satine_elated_get_woo_shortcode_module_template_part('templates/product-list-carousel', 'product-list-carousel', '', $params);
