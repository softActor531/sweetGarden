...
if ( ! function_exists('satine_elated_contact_form_7_options_map') ) {

	function satine_elated_contact_form_7_options_map() {

		satine_elated_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'satine'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = satine_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'satine')
		));

		//Text Typography

		$typography_text_group = satine_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'satine'),
			'description'	=> esc_html__('Setup typography for form elements text', 'satine'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = satine_elated_add_admin_row(array(
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'satine'),
		));
		...
		$typography_text_row2 = satine_elated_add_admin_row(array(
		...
		$typography_text_row3 = satine_elated_add_admin_row(array(
		...
		$typography_label_group = satine_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'satine'),
			'description'	=> esc_html__('Setup typography for form elements label', 'satine'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = satine_elated_add_admin_row(array(
		...
		$typography_label_row2 = satine_elated_add_admin_row(array(
		...
		$background_border_group = satine_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'satine'),
			'description'	=> esc_html__('Setup form elements background and border style', 'satine'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = satine_elated_add_admin_row(array(
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'satine')
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'satine')
		));

		$background_border_row2 = satine_elated_add_admin_row(array(
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'satine'),
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'satine')
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'satine')
		));

		$background_border_row3 = satine_elated_add_admin_row(array(
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'satine'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'satine'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = satine_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'satine'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = satine_elated_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'satine'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'satine'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'satine'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'satine'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = satine_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'satine'),
			'description'	=> esc_html__('Setup form elements margin', 'satine'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = satine_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'satine'),
			'description'	=> esc_html__('Enter height for textarea form element', 'satine'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = satine_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'satine'),
			'description'	=> esc_html__('Setup button text typography', 'satine'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = satine_elated_add_admin_row(array(
		...
		$button_typography_row2 = satine_elated_add_admin_row(array(
		...
		$button_background_border_group = satine_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'satine'),
			'description'	=> esc_html__('Setup button background and border style', 'satine'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = satine_elated_add_admin_row(array(
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'satine')
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'satine')
		));

		$button_background_border_row2 = satine_elated_add_admin_row(array(
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'satine')
		));
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'satine')
		));

		$button_background_border_row3 = satine_elated_add_admin_row(array(
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'satine'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		satine_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'satine'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = satine_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'satine')
		));
        ...
        $panel_contact_form_style_3 = satine_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'satine')
        ));
        ...
        $typography_label_row3 = satine_elated_add_admin_row(array(
        ...
        $button_typography_row3 = satine_elated_add_admin_row(array(
	...
	add_action( 'satine_elated_options_map', 'satine_elated_contact_form_7_options_map', 16);
}