...
class HeaderDivided extends HeaderType {
    ...
    public function calculateHeightOfTransparency() {
        ...
        if(get_post_meta($id, 'eltdf_menu_area_background_transparency_meta', true) !== '1' && get_post_meta($id, 'eltdf_menu_area_background_transparency_meta', true) !== ''){
            $menuAreaTransparent = true;
        } else if (satine_elated_options()->getOptionValue('menu_area_background_transparency') !== '1' && satine_elated_options()->getOptionValue('menu_area_background_transparency') !== '') {
            $menuAreaTransparent = true;
        } else if (is_404() && satine_elated_options()->getOptionValue('404_menu_area_background_transparency_header') !== '1' && satine_elated_options()->getOptionValue('404_menu_area_background_transparency_header') !== '') {
            $menuAreaTransparent = true;
        } else {
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        $menuAreaTransparent = satine_elated_options()->getOptionValue('fixed_header_transparency') === '0';
    ...
    public function getPerPageJSVariables($perPageVars) {
        ...
        if(!in_array(satine_elated_options()->getOptionValue('header_behaviour'), array('sticky-header-on-scroll-up','sticky-header-on-scroll-down-up'))) {
