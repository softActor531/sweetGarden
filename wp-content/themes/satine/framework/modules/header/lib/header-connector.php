...
class HeaderConnector {
    ...
    public function connect($config = array()) {
        do_action('satine_elated_pre_header_connect');
        ...
        if(!empty($config['affect_content'])) {
            add_filter('satine_elated_content_elem_style_attr', array($this, 'contentMarginFilter'));
        }

        if(!empty($config['affect_title'])) {
            add_filter('satine_elated_title_content_padding', array($this, 'titlePaddingFilter'));
        }

        do_action('satine_elated_after_header_connect');
    }
     ...
     *
     * Hooks to satine_elated_title_content_padding filter
     *
     * @return int
     */
