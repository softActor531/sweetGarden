...
if (!class_exists('SatineElatedTopNavigationWalker')) {
	class SatineElatedTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<i aria-hidden="true" class="eltdf-menu-arrow lnr lnr-arrow-right"></i>';
				}
