 ...
 */
$product_info_position = satine_elated_options()->getOptionValue('eltdf_woo_product_list_info_position');
?>
...
<li <?php post_class(); ?>>
	...
	if($product_info_position === 'info_below_image') {
		...
		do_action( 'satine_elated_woo_pl_info_below_image' );

	} else if($product_info_position === 'info_on_image_hover') {

		do_action( 'satine_elated_woo_pl_info_on_image_hover' );
	}
