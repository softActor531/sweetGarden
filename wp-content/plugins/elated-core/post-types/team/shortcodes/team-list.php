		    ...
		    vc_map( array(
				    ...
				    'params'                    => array(
                        ...
                        array(
                            ...
                            'heading'     => esc_html__('Display Description', 'eltdf-core'),
                        ...
                        array(
                            ...
                            'heading'     => esc_html__('Display Social Icons', 'eltdf-core'),
                            'value'       => array_flip(satine_elated_get_yes_no_select_array(false)),
                            'dependency' => array('element' => 'team_member_layout', 'value' => 'info-bellow')
                        ),
                        array(
                            ...
                            'heading'    => esc_html__('Team Member Image Layout', 'eltdf-core'),
                            'value'      => array(
