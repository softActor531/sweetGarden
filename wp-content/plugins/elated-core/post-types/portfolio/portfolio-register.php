...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $satine_Framework, $satine_options;
        ...
        if(eltdf_core_theme_installed()) {
            ...
            if(isset($satine_options['portfolio_single_slug'])) {
                if($satine_options['portfolio_single_slug'] != ""){
                    $slug = $satine_options['portfolio_single_slug'];
                }
            }
        }
