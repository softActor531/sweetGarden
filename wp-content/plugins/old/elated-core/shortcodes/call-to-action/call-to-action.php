...
class CallToAction implements Lib\ShortcodeInterface {
				...
				'params' => array(
					array(
						...
						'value'      => array(
							...
							esc_html__('Minimal', 'eltdf-core') => 'minimal',
						)
					),
					array(
						'type'        => 'dropdown',
					...
					array(
						...
						'group'      => esc_html__('Button Style', 'eltdf-core'),
						'dependency'  => array('element' => 'layout', 'value' => array('normal', 'simple'))
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'dependency' => array('element' => 'button_type', 'value' => array('solid', 'with-arrow')),
						'group'      => esc_html__('Button Style', 'eltdf-core'),
					),
					array(
						'type'       => 'colorpicker',
	...
	private function getButtonHolderStyles($params) {
		...
		if (!empty($params['button_top_margin']) && $params['layout'] === 'simple') {
			$styles[] = 'margin-top: '.satine_elated_filter_px($params['button_top_margin']).'px';
		}
