<?php
namespace ElatedCore\CPT\Shortcodes\Message;
...
class Message implements Lib\ShortcodeInterface	{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Message', 'eltdf-core'),
			'base' => $this->base,
				...
				array(
					array(
						...
						'value' => array(
							...
							esc_html__('With Icon', 'eltdf-core') => 'with_icon'
						),
						'save_always' => true
					)
				),
                satine_elated_icon_collections()->getVCParamsArray(array('element' => 'type', 'value' => 'with_icon')),
				array(
					array(
						'type' => 'colorpicker',
					...
					array(
						...
						'description' => esc_html__('Default value is 0','eltdf-core'),
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Color', 'eltdf-core'),
						'param_name'  => 'close_icon_color',
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Hover Color', 'eltdf-core'),
	...
	public function render($atts, $content = null) {
		...
		$args = array_merge($args, satine_elated_icon_collections()->getShortcodeParams());
		...
		if ($type == 'with_icon') {
			$message_classes .= ' eltdf-with-icon';
		...
		$html = eltdf_core_get_shortcode_module_template_part('templates/message-holder-template', 'message', '', $params);
