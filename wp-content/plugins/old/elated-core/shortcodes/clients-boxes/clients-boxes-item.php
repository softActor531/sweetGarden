<?php
namespace ElatedCore\CPT\Shortcodes\ClientsBoxesItem;
...
class ClientsBoxesItem implements Lib\ShortcodeInterface{
	...
	public function vcMap() {
		vc_map(array(
			'name' => esc_html__('Elated Clients Boxes Item', 'eltdf-core'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$html = eltdf_core_get_shortcode_module_template_part('templates/clients-boxes-item', 'clients-boxes', '', $params);
