<?php
if ( ! function_exists( 'satine_elated_init_google_fonts_array' ) ) {
    function satine_elated_init_google_fonts_array() {
    ...
    add_action('after_setup_theme', 'satine_elated_init_google_fonts_array');
}