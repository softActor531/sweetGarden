				    ...
				    'params'                    => array(
					    ...
					    array(
						    ...
						    'value'       => array(
							    ...
							    esc_html__( 'Standard - Move Up', 'eltdf-core' ) => 'standard-move-up',
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Shadow Around Item', 'eltdf-core'),
    ...
    */
	public function getHolderClasses($params){
        ...
        if ($params['shadow_around_item'] == 'yes') {
            $classes[] = 'eltdf-pl-shadow-around-item';
        }
